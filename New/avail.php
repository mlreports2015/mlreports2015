...
$s3="select * from appoint where tm='".date('H:i',$time)."' and dt='$d' and dr='$doc'";
// echo $s3;
$q3=mysql_query($s3);
$r3=mysql_fetch_array($q3);

$s4="select * from patient where id='".$r3['id']."'";
// echo $s4;
$q4=mysql_query($s4);
$r4=mysql_fetch_array($q4);
	echo "<tr><td>".date('H:i',$time)."</td><td>";

$s5="select * from stat where tm='".date('H:i',$time)."' and dt='$d' and dr='$doc'";
$q5=mysql_query($s5);
...
<input type="submit" value="<?php echo $r4['fn']." ".$r4['ln'];?>" size="150" style="width:150px;color:<?php if ($r5['stat']=='0') echo "#000;"; else if ($r5['stat']=='1') echo "#00F;"; else if ($r5['stat']=='2') echo "#F00;"; else if ($r5['stat']=='3') echo "#0F0;"; else if ($r5['stat']=='4') echo "#777"; ?>">
</form>
