...
$s="insert into cclist set org='".$_SESSION['o']."', lnm='".$_SESSION['n']."', cn='$cn1', cp='$cpc', latlong='$ll', ca='$ca', ct='$cct', cc='$cc', fax='$cf', ce='$eml'";
	
	echo "<div align='center'>";
if (mysql_query($s))
{
		echo "Clinic Added<br>";
}
else
{
