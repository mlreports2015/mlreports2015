                                ...
                                <div align='center' style="position:relative;width:98%;padding:10px;background-color:rgba(54,140,204,0.5);">
                                    ...
                                    <table align='center' width='97%' cellpadding="10px" style="font-family:Arial, Helvetica, sans-serif;font-size:15px;font-weight:bold;color:#FFF;">
                                        <form id="regfrm" name="regfrm" method="post" action="./process/registerP.php">
                                            ...
                                            <tr>
                                                <td colspan='2' style="font-weight:normal;"><p>Please Register with us today, to gain access to up to date information on your appointments and cases. <br/> Help us with our commitment to the legal community.</p></td>
                                            </tr>
                                            <tr>
                                                <td>Organisation Type</td><td><select id="orgtyp" name="orgtyp" class="form-control" ><option value="solic">Solicitors</option><option value="refers">Referrer</option><option value="exprt">Expert</option></select>
                                            </tr>
                                            <tr id="orgnmtr" name="orgnmtr">
                                                <td>Organisation Name</td><td><input type="text" id="orgnm" name="orgnm" class="required form-control"  style="width:80%;" placeholder="company name"/></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>Contact Name</td><td><input type="text" id="orgcont" name="orgcont" class="required form-control" style="width:80%;" placeholder="main contact" /></td>
                                            </tr>
                                            <tr>
                                                <td>Organisation Address 1</td><td><input type="text" id="addy1" name="addy1" class="required form-control" style="width:80%;"  /></td>
                                            </tr>
                                            <tr>
                                                <td>Organisation Address 2</td><td><input type="text" id="addy2" name="addy2" class="form-control" style="width:80%;" /></td>
                                            </tr>
                                            <tr>
                                                <td>Organisation Postcode</td><td><input type="text" id="orgpcode" name="orgpcode" class="required form-control" style="width:80%;" placeholder="postcode" /></td>
                                            </tr>
                                            <tr>
