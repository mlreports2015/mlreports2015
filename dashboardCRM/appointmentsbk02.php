...
<div class="panel panel-default" style="border-radius:0px;margin-top:-20px;">
					...
					while ($r=  mysql_fetch_array($q2))
                     {
					  ...
					  echo '</td>';
					  echo '<td><a href="addAppointment.php?exp='.$r['typcounter'].'&loc='.$city['city'].'" class="btn btn-info" style="height:30px;" title="request expert">Request</a></td>';
					  echo '</tr>';
