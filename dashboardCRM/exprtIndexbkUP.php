...
<div class="navbar navbar-default" style="width:100%;background-color:rgba(255,0,0,0.8);margin:0px;height:30px;">
  <div class="container-fluid">
    ...
    <a class="navbar-brand" href="exprtIndex.php" title="MLPortal" style="text-decoration:none;color:#903;font-style:italic;font-family:'Times New Roman', Times, serif">ML PORTAL</a>
    </div>
    ...
    <div class="breadcrumb" style="text-align:right;font-style:italic;"><a href="expertSave.php" ><?php echo $_SESSION['usr'] ;?></a> currently logged in</div>
   ...
   <h3 align="left">MONTHLY STATS</h3>
    <div style="width:100%;height:110px;">
        ...
        <h2>New Cases: <span class="badge" style="width:80px;height:40px;font-size:30px;font-weight:bold;" >25</span></h2>
    </div>
    <div style="float:left;width:30%">
...
<div align='center' style="width:90%">
    ...
    <div style="width:101%;">
    <h3 style="float:left;width:80%;text-align:left;">10 LATEST APPOINTMENTS <div id="moreapps" name="moreapps" style="float:right;">click</div></h3>
     </div>
