...
<form action="clinicEditP.php" method="post" name="frm" id="frm">
<table width="350">
<TR>
<TD>Name</TD><TD><input type="hidden" value="<?php echo $r['cid'];?>" name="cid" /><INPUT value="<?php echo $r['cn'];?>" type='text' id="cn1" name='cn1'><input type="hidden" name="org" value="<?php echo $_SESSION['o'];?>" /><input type="hidden" name="lnm" value="<?php echo $_SESSION['n'];?>" /></TD>
</TR>
<tr>
<TD>Post Code</TD><TD><input style="width:90px;" value="<?php echo $r['cp']; ?>" type="text" name="cpc" id="cpc" /><input type="hidden" value="<?php echo $ll[0];?>" name="lat" id="lat" /><input type="hidden" value="<?php echo $ll[1];?>" name="long" id="long" /><input type="button" value="Find" onClick="clearest(); javascript:usePointFromPostcode(document.getElementById('cpc').value, showPointLatLng); addressFind();" /></TD>
</tr>
<tr>
<TD>Address Line 1</TD><TD><INPUT type='text' id="ca1" name='ca1' value="<?php echo $ca; ?>"></TD>
</tr>
<tr>
<TD>Address Line 2</TD><TD><input type="text" id="cty" name="cct" value='<?php echo $r['ct'];?>' /></td>
</tr>
<tr>
<TD>Contact</TD><TD><INPUT type='text' id="cc" name='cc' value='<?php echo $r['cc'];?>'></TD>
</tr>
<tr>
<TD>Fax</TD><TD><INPUT type='text' id="cf" name='cf' value='<?php echo $r['fax'];?>'></TD>
</tr>
<tr>
<td>Email</td><td><input type="text" id="eml" name="ce" value='<?php echo $r['ce'];?>'/></td>
</tr>
<tr>
