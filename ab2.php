...
<td><input type="text" value='<?php echo $_POST['dt'];?>' readonly="true" id="dt" size=16px name=dt id='dt' class='inp' /><a href='#' onClick="setYears(1900, 2011); showCalender(this, 'dt');"><img src='images/calender.png' border=0 /></a><input type="submit" value="GO"></td>
</tr>
...
$d=date('Y-m-d', strtotime($_POST['dt']));
$sd="select * from login where org='".$_SESSION['o']."' and stat='d'";
$q=mysql_query($sd);
...
<input type="submit" <?php if (strtotime($d)<strtotime(date('Y-m-d'))) echo "disabled=true"; ?> value="<?php echo $r4['cfn']." ".$r4['cln'];?>" size="150" style="width:150px;">
</form>
