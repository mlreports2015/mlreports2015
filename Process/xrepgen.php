...
$str2=str_replace("|isymp|",$eff1,$str2);
$str2=str_replace("|lsymp|",$eff2,$str2);

$str2=str_replace("|itreat|",$tr1,$str2);
$str2=str_replace("|ltreat|",$tr2,$str2);

$str2=str_replace("|inv|",$inv,$str2);

$str2=str_replace("|eaw|",$jb,$str2);

$str2=str_replace("|hcc|",$hcc,$str2);

$str2=str_replace("|trvl|",$trv,$str2);

$str2=str_replace("|dlv|",$dlv,$str2);

$str2=str_replace("|dh|",$dh,$str2);

$str2=str_replace("|ga|",$ga,$str2);

$str2=str_replace("|iws|",$iw,$str2);

$str2=str_replace("|eon|",$eon,$str2);
$str2=str_replace("|eou|",$eou,$str2);
$str2=str_replace("|eob|",$eob,$str2);
$str2=str_replace("|eol|",$eol,$str2);

$str2=str_replace("|sum|", $sum,$str2);

$str2=str_replace("|jp|", $jp,$str2);

$str2=str_replace("|ppp|", $ppp,$str2);

$str2=str_replace("|G1|", $G1,$str2);
...
$cell->writeText('<strong>Dr H Rehman</strong><br><strong>MBBS MRCOG</strong><br>60 Thornton Lodge Road<br>Huddersfield HD1 3SB<br><strong>MEDICOLEGAL REPORT</strong><br><strong>Prepared for the Courts</strong>', new Font(14, 'Arial'), $parCenter);
