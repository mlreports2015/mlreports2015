...
<div align='center' style="width:95%;height:400px;overflow:hidden;">
<div style="width:700px;height:375px;border:1px solid #77a9c9;padding:5px;border-radius:6px;">
<form action="clinicSaveP.php" method="post" name="frm" id="frm" style="font-family:Verdana, Geneva, sans-serif;">
<table width="88%" height="250px" border="0" cellpadding="6px">
<TR>
<TH colspan='2'>NEW CLINIC<br/>(enter the new clinic details below)</TH>
</TR>
<TR>
